...
public enum F1155Channels implements Channel {
     ...
     */
    F1155Channels(String id, String name, ChannelGroup channelGroup, ValueType valueType, String writeApiUrl,
     ...
     * @param javaType
     */
    F1155Channels(String id, String name, ChannelGroup channelGroup, ValueType valueType) {
